...
func (sess *ShardingSessionClient) watch(c zrpc.RpcClientConf) {
	// Initialize Subscriber and check for error_types
...
func (sess *ShardingSessionClient) InvokeByKey(
	key string, cb func(client sessionclient.SessionClient) (err error),
) error {
